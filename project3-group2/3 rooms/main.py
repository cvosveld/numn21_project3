...
if __name__ == "__main__":
    ...
    rank = comm.Get_rank()
    if rank == 0:
        print("Starting 3-room simulation with MPI...")
    ...
    if rank == 1:
        plot_apt(ud1, title=f'3-Room Solution (Heater at {setup1.params["u_H"]}C)', interpolation=interpolation)
        plot_apt(ud2, title=f'3-Room Solution (Heater at {setup2.params["u_H"]}C)', interpolation=interpolation)
